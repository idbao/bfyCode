...
public class GridKillerViewerSorter extends ViewerSorter {

	private int sort;

	private Class cla;// 实体类的全名

	private String[] attName;// 属性数组
	private Method midmethod;

	public GridKillerViewerSorter(int sort, Class cla, String[] attName) {
		this.sort = sort;
	...
	public int compare(Viewer viewer, Object obj1, Object obj2) {
		...
		try {
//			cla = Class.forName(pack);// 得到pack的类型
			cla=this.cla;
