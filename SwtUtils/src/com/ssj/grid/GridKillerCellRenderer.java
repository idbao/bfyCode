 ...
 *
 */
public class GridKillerCellRenderer extends GridCellRenderer {
	private Color selectedColor,selectedText;//背景色和字体色
	private Font textFont;//字体
	
	public GridKillerCellRenderer(Color color,Color textColor,Font textFont){
		this.selectedColor=color;
		this.selectedText=textColor;
    ...
    public void paint(GC gc, Object value)
    {
        ...
        if (!isWordWrap())
        {
            ...
            gc.drawString(text, getBounds().x+3,getBounds().y + textTopMargin + topMargin, true);//getBounds().x + x, getBounds().y + textTopMargin + topMargin
        }
        else
        {
            if (textLayout == null)
