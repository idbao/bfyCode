...
public class ExportMenuDropAction implements IMenuCreator {
	...
	protected final static int HTML=5,PDF=4,WORD=6;
	protected static String title="维修项目所需人员表";
	protected Color borderColor=new Color(0 ,191, 255),
	...
	public ExportMenuDropAction(GridTableViewer grid) {
	...
	protected void createXLS(GridTableViewer gridViewer, String path) {
	...
	public void create(GridTableViewer gridViewer,String path,int type) {
		...
		try {
		   ...
		   Font FontChinese = new Font(bf, 10, Font.NORMAL,textColor);   
			...
			//创建一个新段落
			Paragraph title1 = new Paragraph(title,FontChinese);
			//创建一个章节，参数为所属的段落
	...
	public void createDoc(GridTableViewer gridViewer,String path) {
		try{
