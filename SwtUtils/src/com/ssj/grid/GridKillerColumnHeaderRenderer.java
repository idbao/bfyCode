...
public class GridKillerColumnHeaderRenderer extends GridHeaderRenderer {
	...
	public void paint(GC gc, Object value) {
		...
		gc.setBackground(GridKillerColor.headColor);//TODO 背景色152, 245 ,255-->SWT.COLOR_WIDGET_BACKGROUND
		...
		gc.setForeground(GridKillerColor.headTextColor);//TODO 字的颜色SWT.COLOR_BLACK
...
//						SWT.COLOR_BLACK));//TODO 按下时左 上的颜色
//			} else {
//				gc.setForeground(SWTResourceManager.getColor(211,211,211));//TODO 未按下时左 上的颜色
//			}
//
...
//			
			if (!drawSelected) {
				gc.setForeground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_NORMAL_SHADOW));//TODO 未按下时左 上的颜色
...
//
//				gc.setForeground(getDisplay().getSystemColor(
//						SWT.COLOR_CYAN));//TODO 未按下时右 下的颜色
