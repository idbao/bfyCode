 ...
 * @since 2.0.0
 */
public class GridKillerEmptyCellRenderer extends GridCellRenderer
{

	private Color selectedColor,selectedText;
    
	public GridKillerEmptyCellRenderer(Color color,Color textColor){
